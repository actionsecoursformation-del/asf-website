...
<li><a href="formation-dae.html" ${currentPage==='formation-dae.html'?'class="active"':''}>❤️ Gestes de premiers secours / DAE</a></li>
            <li><a href="formation-habilitation-electrique-h0b0.html" ${currentPage==='formation-habilitation-electrique-h0b0.html'?'class="active"':''}>⚡ Habilitation électrique H0 B0</a></li>
          </ul>
        </li>
        <li><a href="osteopathe-entreprise.html" ${currentPage==='osteopathe-entreprise.html'?'class="active"':''}>Santé &amp; bien-être</a></li>
        <li>
          <a href="audit-securite-erp.html"
             ${currentPage==='audit-securite-erp.html' || currentPage==='prevention-risques.html'?'class="active"':''}>
...
<p>Organisme de formation spécialisé en SST et sécurité incendie, basé en Île-de-France. Formateur certifié, sapeur-pompier. Déplacement possible partout en France sur demande.</p>
        </div>
      <div>
        <h4>Formations</h4>
        <ul>
...
<li><a href="formation-dae.html">❤️ Gestes de premiers secours / DAE</a></li>
          <li><a href="formation-habilitation-electrique-h0b0.html">⚡ Habilitation électrique H0 B0</a></li>
          <li><a href="audit-securite-erp.html">🛡️ Prévention des risques</a></li>
</ul>
      </div>
      <div>
        <h4>Contact</h4>
