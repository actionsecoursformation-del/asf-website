...
<li><a href="formation-dae.html" ${currentPage==='formation-dae.html'?'class="active"':''}>❤️ Gestes de premiers secours / DAE</a></li>
        ...
        <li>
          <a href="prevention-risques.html"
             ${currentPage==='prevention-risques.html' || currentPage==='audit-securite-erp.html'?'class="active"':''}>
...
<li><a href="formation-dae.html">❤️ Gestes de premiers secours / DAE</a></li>
          <li><a href="prevention-risques.html">🛡️ Prévention des risques</a></li>
</ul>
      </div>
      <div>
        <h4>Contact</h4>
